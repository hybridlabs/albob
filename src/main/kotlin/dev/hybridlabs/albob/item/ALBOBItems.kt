...
object ALBOBItems {
    ...
    val OIL_BARREL = register("oil_barrel", ALBOBlocks.OIL_BARREL)
    val WHITE_OIL_BARREL = register("white_oil_barrel", ALBOBlocks.WHITE_OIL_BARREL)
    val ORANGE_OIL_BARREL = register("orange_oil_barrel", ALBOBlocks.ORANGE_OIL_BARREL)
    val MAGENTA_OIL_BARREL = register("magenta_oil_barrel", ALBOBlocks.MAGENTA_OIL_BARREL)
    val LIGHT_BLUE_OIL_BARREL = register("light_blue_oil_barrel", ALBOBlocks.LIGHT_BLUE_OIL_BARREL)
    val YELLOW_OIL_BARREL = register("yellow_oil_barrel", ALBOBlocks.YELLOW_OIL_BARREL)
    val LIME_OIL_BARREL = register("lime_oil_barrel", ALBOBlocks.LIME_OIL_BARREL)
    val PINK_OIL_BARREL = register("pink_oil_barrel", ALBOBlocks.PINK_OIL_BARREL)
    val GRAY_OIL_BARREL = register("gray_oil_barrel", ALBOBlocks.GRAY_OIL_BARREL)
    val LIGHT_GRAY_OIL_BARREL = register("light_gray_oil_barrel", ALBOBlocks.LIGHT_GRAY_OIL_BARREL)
    val CYAN_OIL_BARREL = register("cyan_oil_barrel", ALBOBlocks.CYAN_OIL_BARREL)
    val PURPLE_OIL_BARREL = register("purple_oil_barrel", ALBOBlocks.PURPLE_OIL_BARREL)
    val BLUE_OIL_BARREL = register("blue_oil_barrel", ALBOBlocks.BLUE_OIL_BARREL)
    val BROWN_OIL_BARREL = register("brown_oil_barrel", ALBOBlocks.BROWN_OIL_BARREL)
    val GREEN_OIL_BARREL = register("green_oil_barrel", ALBOBlocks.GREEN_OIL_BARREL)
    val RED_OIL_BARREL = register("red_oil_barrel", ALBOBlocks.RED_OIL_BARREL)
    val BLACK_OIL_BARREL = register("black_oil_barrel", ALBOBlocks.BLACK_OIL_BARREL)

...
class BlockTagProvider(output: FabricDataOutput, future: CompletableFuture<HolderLookup.Provider>) : FabricTagProvider.BlockTagProvider(output, future) {
    override fun addTags(lookup: HolderLookup.Provider) {
        getOrCreateTagBuilder(BlockTags.MINEABLE_WITH_PICKAXE).let { builder ->
            ...
            builder.add(ALBOBlocks.OIL_BARREL)
            builder.add(ALBOBlocks.WHITE_OIL_BARREL)
            builder.add(ALBOBlocks.ORANGE_OIL_BARREL)
            builder.add(ALBOBlocks.MAGENTA_OIL_BARREL)
            builder.add(ALBOBlocks.LIGHT_BLUE_OIL_BARREL)
            builder.add(ALBOBlocks.YELLOW_OIL_BARREL)
            builder.add(ALBOBlocks.LIME_OIL_BARREL)
            builder.add(ALBOBlocks.PINK_OIL_BARREL)
            builder.add(ALBOBlocks.GRAY_OIL_BARREL)
            builder.add(ALBOBlocks.LIGHT_GRAY_OIL_BARREL)
            builder.add(ALBOBlocks.CYAN_OIL_BARREL)
            builder.add(ALBOBlocks.PURPLE_OIL_BARREL)
            builder.add(ALBOBlocks.BLUE_OIL_BARREL)
            builder.add(ALBOBlocks.BROWN_OIL_BARREL)
            builder.add(ALBOBlocks.GREEN_OIL_BARREL)
            builder.add(ALBOBlocks.RED_OIL_BARREL)
            builder.add(ALBOBlocks.BLACK_OIL_BARREL)

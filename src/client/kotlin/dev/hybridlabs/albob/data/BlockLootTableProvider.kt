...
internal class BlockLootTableProvider(output: FabricDataOutput) : FabricBlockLootTableProvider(output) {
    override fun generate() {
        ...
        dropSelf(ALBOBlocks.OIL_BARREL)
        dropSelf(ALBOBlocks.WHITE_OIL_BARREL)
        dropSelf(ALBOBlocks.ORANGE_OIL_BARREL)
        dropSelf(ALBOBlocks.MAGENTA_OIL_BARREL)
        dropSelf(ALBOBlocks.LIGHT_BLUE_OIL_BARREL)
        dropSelf(ALBOBlocks.YELLOW_OIL_BARREL)
        dropSelf(ALBOBlocks.LIME_OIL_BARREL)
        dropSelf(ALBOBlocks.PINK_OIL_BARREL)
        dropSelf(ALBOBlocks.GRAY_OIL_BARREL)
        dropSelf(ALBOBlocks.LIGHT_GRAY_OIL_BARREL)
        dropSelf(ALBOBlocks.CYAN_OIL_BARREL)
        dropSelf(ALBOBlocks.PURPLE_OIL_BARREL)
        dropSelf(ALBOBlocks.BLUE_OIL_BARREL)
        dropSelf(ALBOBlocks.BROWN_OIL_BARREL)
        dropSelf(ALBOBlocks.GREEN_OIL_BARREL)
        dropSelf(ALBOBlocks.RED_OIL_BARREL)
        dropSelf(ALBOBlocks.BLACK_OIL_BARREL)

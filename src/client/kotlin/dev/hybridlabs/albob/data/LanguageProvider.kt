...
internal class LanguageProvider(output: FabricDataOutput) : FabricLanguageProvider(output) {
    ...
    private fun registerBlocks(builder: TranslationBuilder) {
        ...
        builder.add(ALBOBlocks.OIL_BARREL, "Oil Barrel")
        builder.add(ALBOBlocks.WHITE_OIL_BARREL, "White Oil Barrel")
        builder.add(ALBOBlocks.ORANGE_OIL_BARREL, "Orange Oil Barrel")
        builder.add(ALBOBlocks.MAGENTA_OIL_BARREL, "Magenta Oil Barrel")
        builder.add(ALBOBlocks.LIGHT_BLUE_OIL_BARREL, "Light Blue Oil Barrel")
        builder.add(ALBOBlocks.YELLOW_OIL_BARREL, "Yellow Oil Barrel")
        builder.add(ALBOBlocks.LIME_OIL_BARREL, "Lime Oil Barrel")
        builder.add(ALBOBlocks.PINK_OIL_BARREL, "Pink Oil Barrel")
        builder.add(ALBOBlocks.GRAY_OIL_BARREL, "Gray Oil Barrel")
        builder.add(ALBOBlocks.LIGHT_GRAY_OIL_BARREL, "Light Gray Oil Barrel")
        builder.add(ALBOBlocks.CYAN_OIL_BARREL, "Cyan Oil Barrel")
        builder.add(ALBOBlocks.PURPLE_OIL_BARREL, "Purple Oil Barrel")
        builder.add(ALBOBlocks.BLUE_OIL_BARREL, "Blue Oil Barrel")
        builder.add(ALBOBlocks.BROWN_OIL_BARREL, "Brown Oil Barrel")
        builder.add(ALBOBlocks.GREEN_OIL_BARREL, "Green Oil Barrel")
        builder.add(ALBOBlocks.RED_OIL_BARREL, "Red Oil Barrel")
        builder.add(ALBOBlocks.BLACK_OIL_BARREL, "Black Oil Barrel")
